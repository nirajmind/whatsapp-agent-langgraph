...
HF_DOWNLOADER_IMAGE_TAG = $(COMPOSE_PROJECT_NAME)_hf_models_downloader:$(VERSION)

WHATSAPP_DOCKERFILE = Dockerfile.whatsapp
WHATSAPP_IMAGE_TAG = $(COMPOSE_PROJECT_NAME)_whatsapp:$(VERSION)

CHAINLIT_DOCKERFILE = Dockerfile.chainlit
CHAINLIT_IMAGE_TAG = $(COMPOSE_PROJECT_NAME)_chainlit:$(VERSION)
