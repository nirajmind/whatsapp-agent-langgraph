...
2. Your response must be a JSON object with a single field 'response_type' that is one of: 'conversation', 'image', or 'audio'
...
{{
    "response_type": "conversation"  # or "image" or "audio"
}}
"""
